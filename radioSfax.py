...
for i in range(2):
  page_link_list.append("http://www.radiosfax.tn/category/%D8%A7%D8%AE%D8%A8%D8%A7%D8%B1-%D8%A7%D9%84%D8%AC%D9%87%D8%A9/page/"+str(i+1)+"/")
...
df.to_csv(r'C:\Users\User\Desktop\web scraping py\RadioSfaxAR.csv' ,encoding='utf-8-sig')
