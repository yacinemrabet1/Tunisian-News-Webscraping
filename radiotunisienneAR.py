...
article_title_list=[]
for i in range(3):
  page_link_list.append("http://www.radiotunisienne.tn/all-news/page/"+str(i+1)+"/")
...
df.to_csv(r'C:\Users\User\Desktop\web scraping py\radiotunisienneAR.csv' ,encoding='utf-8-sig')
