...
for i in range(2):
  page_link_list.append("https://www.ifm.tn/fr/articles?page="+str(i+1))
...
df.to_csv(r'C:\Users\User\Desktop\web scraping py\ifmFR.csv' ,encoding='utf-8-sig')
...
df.to_csv(r'C:\Users\User\Desktop\web scraping py\ifmAR.csv' ,encoding='utf-8-sig')
