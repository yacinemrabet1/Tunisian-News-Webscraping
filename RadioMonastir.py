...
for i in range(2):
  page_link_list.append("http://www.radiomonastir.tn/all-news/page/"+str(i+1)+"/")
...
df.to_csv(r'C:\Users\User\Desktop\web scraping py\RadioMonastirAR.csv' ,encoding='utf-8-sig')
